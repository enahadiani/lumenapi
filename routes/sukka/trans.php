...
$router->group(['middleware' => 'auth:yptkug'], function () use ($router) {
    ...
    $router->get('juskeb-nobukti','Sukka\PengajuanJuskebController@generateNo');
    ...
    $router->get('juskeb-lokasi', 'Sukka\PengajuanJuskebController@getLokasi');
    $router->get('juskeb-akun', 'Sukka\PengajuanJuskebController@getAkun');
    $router->get('juskeb-drk', 'Sukka\PengajuanJuskebController@getDRK');
    $router->get('juskeb-drk-beri', 'Sukka\PengajuanJuskebController@getDRKPemberi');
    ...
    $router->get('aju-rra-juskeb','Sukka\PengajuanRRAController@getJuskeb');
