...
class MenuController extends Controller
{
    ...
    public function show($kode_klp)
    {
        try {
            ...
            $menu = DB::connection($this->db)->select("SELECT a.kode_menu, a.nama, a.level_menu, b.id_form as form, a.kode_klp, a.icon from lab_menu a left join lab_form b on a.kode_form=b.kode_form where a.kode_klp='$kode_klp' order by a.nu");
