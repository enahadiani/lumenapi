...
class HakaksesController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            $res = DB::connection($this->sql)->select("select nik,nama,kode_menu_lab as kode_klp_menu,kode_lokasi,status_admin from hakakses where kode_lokasi='".$kode_lokasi."'
            ");
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if($sts){
                ...
                $ins = DB::connection($this->sql)->insert('insert into hakakses(nik,nama,kode_lokasi,kode_klp_menu,pass,status_admin,klp_akses,path_view,menu_mobile,kode_menu_lab,password) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [$request->input('nik'),$request->input('nama'),$kode_lokasi,$request->input('kode_klp_menu'),$request->input('pass'),$request->input('status_admin'),$request->input('klp_akses'),$request->input('path_view'),$request->input('path_view'),$request->input('kode_klp_menu'),app('hash')->make($request->pass)]);
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $upd = DB::connection($this->sql)->update("
            update hakakses set nama=?, kode_menu_lab=?, pass=?, status_admin=?, klp_akses=?, menu_mobile=?, password=?
            where nik=? and kode_lokasi=?
            ",[$request->input('nama'),$request->input('kode_klp_menu'),$request->input('pass'),$request->input('status_admin'),$request->input('klp_akses'),$request->input('path_view'),app('hash')->make($request->pass), $nik,$kode_lokasi]);
