...
class FilterController extends Controller
{
    ...
    function getFilterAnggota(){
        try {
            ...
            $sql="select a.no_agg,a.nama from kop_agg a where a.kode_lokasi='$kode_lokasi' ";
            $res = DB::connection($this->db)->select($sql);
            $res = json_decode(json_encode($res),true);
    ...
    function getFilterNoKartu(Request $request){
        try {
    ...
    function getFilterNoAkru(Request $request){
        try {
    ...
    function getFilterNoBayar(Request $request){
        try {
    ...
    function getFilterNoBatal(Request $request){
        try {
