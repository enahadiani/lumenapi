...
class PembelianNonPPn2Controller extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $versi = isset($r->versi) ? $r->versi : 'V4';
            ...
            $total_sub = floatval($request->total_trans);
            ...
            if ($total_beli == $nilai_trans) {
                ...
                Log::info('Non PPn Total Beli '.$total_beli.' <> Nilai Trans '.$nilai_trans);
            }
