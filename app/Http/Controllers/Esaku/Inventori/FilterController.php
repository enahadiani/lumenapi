...
class FilterController extends Controller
{
    ...
    function getTahunJualSetor(){
        try {
            ...
            $sql="SELECT DISTINCT substring(a.periode,0,5) as tahun
            from brg_trans_d a 
            ...
            where a.modul = ?";
            $res = DB::connection($this->db)->select($sql,['BRGJUAL']);
            $res = json_decode(json_encode($res),true);
