...
class GudangController extends Controller
{
    ...
    public function isUnik($isi,$kode_lokasi){
        ...
        $auth = DB::connection($this->sql)->select("select kode_gudang from brg_gudang where kode_gudang ='".$isi."' and kode_lokasi='".$kode_lokasi."' ");
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if($this->isUnik($request->kode_gudang,$kode_lokasi)){
                ...
                $insert = "insert into brg_gudang(kode_gudang,kode_lokasi,nama,pic,telp,alamat,kode_pp,tgl_input) 
                values (?,?,?,?,?,?,?,getdate())";
