...
class JurnalDokController extends Controller
{
    /**
    ...
    public function destroy(Request $request)
    {
        ...
        try {
            ...
            if(count($res3) > 0){
                ...
                DB::connection($this->db)->commit();
                $success['status'] = true;
                $success['message'] = "Data Dokumen Jurnal berhasil dihapus";
            }else{
                $success['status'] = false;
                $success['message'] = "Data Dokumen Jurnal gagal dihapus.";
            }
            ...
            DB::connection($this->db)->rollback();
            $success['status'] = false;
            $success['message'] = "Data Dokumen Jurnal gagal dihapus ".$e;
