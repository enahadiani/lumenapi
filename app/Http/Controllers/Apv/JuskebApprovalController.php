...
class JuskebApprovalController extends Controller
{
    ...
    public function getPreview($no_bukti)
    {
        try {
            ...
            $sql="select a.id,a.no_bukti,a.tanggal,b.kode_pp,c.nama as nama_pp,b.kegiatan,b.nilai,b.nik_buat,convert(varchar,a.tanggal,105) as tgl,case when a.status = '2' then 'Approved' when a.status = 'R' then 'Return' end as status
            from apv_pesan a
            inner join apv_juskeb_m b on a.no_bukti=b.no_bukti and a.kode_lokasi=b.kode_lokasi
