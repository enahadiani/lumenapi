        ...
        try {
            ...
            if($sts){
                ...
                for ($i = 0; $i < $jml; $i++) {
                    ...
                    $ins2[$i] = DB::connection($this->db)->insert("insert into fa_nilai(no_fa,kode_lokasi,no_bukti,dc,nilai,periode) values ('".$nbfa2."','".$kode_lokasi."','".$request->no_bukti."','D',".floatval($request->nilai).",'".$request->periode."')");
                    $idx = $idx + 1;
                }
                $sts = true;
