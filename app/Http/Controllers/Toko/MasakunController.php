...
class MasakunController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $ins = DB::connection($this->sql)->insert("insert into masakun (kode_akun,kode_lokasi,nama,modul,jenis,kode_curr,block,status_gar,normal) values ('$request->kode_akun','$kode_lokasi','$request->nama','$request->modul','$request->jenis','$request->kode_curr','$request->block','$request->status_gar','$request->normal') ");
