...
use App\Exports\AnggaranExport2;
...
class AnggaranController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            'tahun' => 'required', 
            'nik_user' => 'required',
            'mode_input' => 'required|in:REPLACE,ADD'
        ]);
        ...
        try {
            ...
            $ins = DB::connection($this->db)->insert("insert into anggaran_m(
                ...
                values ('".$no_bukti."','$kode_lokasi','-',getdate(),'Load Budget','$request->tahun','IDR',".$total.",getdate(),'$nik','X','-','$nik','$nik','$request->mode_input')
            ");
    ...
    public function validateData($kode_akun,$kode_pp,$kode_drk,$tahun,$kode_lokasi){
        ...
        $auth = DB::connection($this->db)->select("select kode_pp from pp where kode_pp='$kode_pp' and kode_lokasi='$kode_lokasi' and flag_aktif = '1'
        ");
        $auth = json_decode(json_encode($auth),true);
        if(count($auth) > 0){
            $keterangan .= "";
    ...
    public function loadAnggaran(Request $request)
    {
        ...
        try {
            ...
            $sql = "select a.kode_akun,a.kode_pp,a.kode_drk,a.n1,a.n2,a.n3,a.n4,a.n5,a.n6,a.n7,a.n8,a.n9,a.n10,a.n11,a.n12,a.tahun 
            from anggaran_tmp a
