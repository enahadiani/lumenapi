...
class LaporanKeuLanjutController extends Controller
{
    ...
    function getCOAStruktur(Request $request){
        try {
            ...
            $sql2 ="select a.kode_neraca,a.nama,a.modul,a.tipe
            from neraca a
            $where and a.modul='P'
            order by a.rowindex ";
            ...
            $sql3 ="select a.kode_neraca,a.nama,a.modul,a.tipe
            from neraca a
            $where and a.modul='L'
            order by a.rowindex ";
    ...
    function getNeracaBulan(Request $request){
        try {
            ...
            $kode_fs=$request->input('kode_fs')[1];
            $level=$request->input('level')[1];
            $sql="exec sp_neraca_tahun_dw '$kode_fs','N','S','$level','$tahun','$kode_lokasi','$nik_user' ";
            $res = DB::connection($this->sql)->update($sql);
            ...
            $sql2="select a.kode_lokasi,a.kode_neraca,a.nama,a.n1*-1 as n01,a.n2*-1 as n02,a.n3*-1 as n03,a.n4*-1 as n04,a.n5*-1 as n05 ,a.n6*-1 as n06,a.n7*-1 as n07,a.n8*-1 as n08,a.n9*-1 as n09,a.n10*-1 as n10,
