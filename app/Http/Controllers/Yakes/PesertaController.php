        ...
        try {
            ...
            foreach($excel as $row){
                if($row[0] != ""){
                    ...
                    $query .= "insert into dash_peserta_tmp(periode,kode_lokasi,jenis,kk,pas,anak,jd,rka_claim,tgl_input,nik_user,sts_upload,ket_upload,nu) values ('".$request->periode."','".$row[1]."','".$row[0]."','".$row[2]."','".$row[3]."','".$row[4]."','".$row[5]."','".$row[6]."',getdate(),'".$request->nik_user."','".$sts."','".$ket."',".$no.");";
                    $no++;
                }
            }
