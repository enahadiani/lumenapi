    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if($this->isUnik($request->kode_pp)){
                $ins = DB::connection($this->sql)->insert("insert into pp(kode_pp,nama,flag_aktif,kode_lokasi,level_spasi,rowindex) values ('".$request->kode_pp."','".$request->nama."','".$request->flag_aktif."','$kode_lokasi','-',0) ");
