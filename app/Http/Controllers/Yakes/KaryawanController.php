...
class KaryawanController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        try {
            ...
            $sql = "select nik,kode_lokasi,nama,alamat,jabatan,no_telp,email,kode_pp, status, no_hp,flag_aktif,isnull(foto,'-') as foto from karyawan where kode_lokasi='".$kode_lokasi."' and nik='$request->nik' 
            ";
