...
class AdminTarbakController extends Controller
{
    ...
    public function profile()
    {
        if($data =  Auth::guard('tarbak')->user()){
            ...
            $user = DB::connection('sqlsrvtarbak')->select("select a.kode_klp_menu, a.nik, a.nama, a.status_admin, a.klp_akses, a.kode_lokasi,b.nama as nmlok, c.kode_pp,d.nama as nama_pp,
    ...
    public function profileGuru()
    {
        if($data =  Auth::guard('tarbak')->user()){
            ...
            $user = DB::connection('sqlsrvtarbak')->select("select a.kode_menu_lab as kode_klp_menu, a.nik, a.nama, a.status_admin, a.klp_akses, a.kode_lokasi,b.nama as nmlok, c.kode_pp,d.nama as nama_pp,
			b.kode_lokkonsol,d.kode_bidang, c.foto,isnull(e.form,'-') as path_view,b.logo,c.no_telp,c.jabatan,a.kode_rumah
            from hakakses a 
            inner join lokasi b on b.kode_lokasi = a.kode_lokasi 
            left join karyawan c on a.nik=c.nik and a.kode_lokasi=c.kode_lokasi 
