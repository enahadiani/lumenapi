...
class AdminTokoController extends Controller
{
    ...
    public function profile()
    {
        if($data =  Auth::guard($this->guard)->user()){
			...
			b.kode_lokkonsol, c.foto,isnull(e.form,'-') as path_view,b.logo,b.kode_kota,isnull(c.background,'-') as background,a.flag_menu,isnull(c.email,'-') as email,c.no_telp,c.jabatan,c.no_hp,isnull(a.pabrik,'-') as pabrik
            from hakakses a 
