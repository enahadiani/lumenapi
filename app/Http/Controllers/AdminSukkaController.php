...
class AdminSukkaController extends Controller
{
    ...
    public function profile()
    {
        if($data =  Auth::guard($this->guard)->user()){
            ...
            $user = DB::connection($this->db)->select("select a.kode_menu_lab as kode_klp_menu, a.nik, a.nama, a.pass, a.status_admin, a.klp_akses, a.kode_lokasi,b.nama as nmlok, c.kode_pp,d.nama as nama_pp,
