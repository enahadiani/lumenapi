...
class KlienController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($this->isUnik($request->input('kode_client'), $kode_lokasi)) {
                ...
                $success['status'] = false;
                $success['message'] = "Error : Duplicate entry. Kode area sudah ada di database!";
            }
            ...
            $success['status'] = false;
            $success['message'] = "Data area gagal disimpan " . $e;
            return response()->json($success, $this->successStatus);
        }
    }
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $success['status'] = true;
            $success['message'] = "Data area berhasil diubah";
            $success['kode'] = $request->kode_client;
            return response()->json($success, $this->successStatus);
        } catch (\Throwable $e) {
            $success['status'] = false;
            $success['message'] = "Data area gagal diubah " . $e;
            return response()->json($success, $this->successStatus);
        }
    }
    ...
    public function destroy(Request $request)
    {
        ...
        try {
            ...
            $success['status'] = true;
            $success['message'] = "Data area berhasil dihapus";

            return response()->json($success, $this->successStatus);
        } catch (\Throwable $e) {
            $success['status'] = false;
            $success['message'] = "Data area gagal dihapus " . $e;
