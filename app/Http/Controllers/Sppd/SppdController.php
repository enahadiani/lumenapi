...
class SppdController extends Controller
{
    ...
    public function generateKode($tabel, $kolom_acuan, $prefix, $str_format){
        $query =DB::connection('sqlsrvyptkug')->select("select right(max($kolom_acuan), ".strlen($str_format).")+1 as id from $tabel where $kolom_acuan like '$prefix%'");
    ...
    public function getPeriodeAktif(){
        ...
        try {
            ...
            $res = DB::connection('sqlsrvyptkug')->select("select max(periode) as periode from periode where kode_lokasi='$kode_lokasi'				 
            ");
    ...
    public function getPP(Request $request){
        ...
        try {
            ...
            $res = DB::connection('sqlsrvyptkug')->select("select a.kode_pp,a.nama,c.bank,c.cabang,c.no_rek,c.nama_rek
            from pp a
    ...
    public function getDrk(Request $request){
        try {
            ...
            $res = DB::connection('sqlsrvyptkug')->select("select a.kode_drk,a.nama
            from drk a
    ...
    public function keepBudget(Request $request){
        ...
        try {
            ...
            $res = DB::connection('sqlsrvyptkug')->select("select status_gar from masakun where kode_akun='".$datam[0]['kode_akun']."' and kode_lokasi='$kode_lokasi' ");
            $res = json_decode(json_encode($res),true);
            if(count($res) > 0){
                    ...
                    if ($datam[0]['total'] > $datam[0]['saldo_budget']) {   
                        ...
                        if ($datam[0]['periode'] < $periode[0]['periode']  ){
                            ...
                            //if ($stsGar == "1") {
                                ...
                                $sql1 = DB::connection('sqlsrvyptkug')->insert("insert into angg_r(no_bukti,modul,kode_lokasi,kode_akun,kode_pp,kode_drk,periode1,periode2,dc,saldo,nilai) values 
                            ...
                            $sql2 = DB::connection('sqlsrvyptkug')->insert($sql);
                            //$success['tmp1']=$sql;
                            ...
                            for ($i=0;$i < count($datad);$i++){
                                ...
                                $insAju = DB::connection('sqlsrvyptkug')->insert($sql);
                                //$success['tmp2']=$sql;
                                ...
                                $insAjud1 = DB::connection('sqlsrvyptkug')->insert($sql);
                                //$success['tmp3']=$sql;
                                ...
                                $insAjud2 = DB::connection('sqlsrvyptkug')->insert($sql);
                                //$success['tmp4']=$sql;
                                ...
                                $insAjud3 = DB::connection('sqlsrvyptkug')->insert($sql);
                                //$success['tmp5']=$sql;
                                ...
                                $sql3 = DB::connection('sqlsrvyptkug')->insert($sql);
                                //$success['tmp6']=$sql;
                                $nu++;
                            }	
                            ...
                            //$success['tmp7']=$sql;
                            $sql5 = DB::connection('sqlsrvyptkug')->insert($sql);	
                            ...
                            if(count($dataDok) > 0 ){
                                for ($i=0;$i < count($dataDok);$i++){
                                    ...
                                    $upload = DB::connection('sqlsrvyptkug')->insert($sql);
                                    $nu++;
                                }	
                            }
                        } 
    ...
    public function releaseBudget($no_agenda){
        ...
        try {
            ...
            $del = DB::connection('sqlsrvyptkug')->table('it_aju_m')->where('kode_lokasi', $kode_lokasi)->where('no_aju', $no_agenda)->delete();
            $del2 = DB::connection('sqlsrvyptkug')->table('it_aju_d')->where('kode_lokasi', $kode_lokasi)->where('no_aju', $no_agenda)->delete();
            $del3 = DB::connection('sqlsrvyptkug')->table('it_aju_rek')->where('kode_lokasi', $kode_lokasi)->where('no_aju', $no_agenda)->delete();
            $del4 = DB::connection('sqlsrvyptkug')->table('angg_r')->where('kode_lokasi', $kode_lokasi)->where('no_bukti', $no_agenda)->delete();
            $del5 = DB::connection('sqlsrvyptkug')->table('tu_pdaju_m')->where('kode_lokasi', $kode_lokasi)->where('no_spj','like' ,$no_agenda.'-%')->delete();
            $del6 = DB::connection('sqlsrvyptkug')->table('tu_pdaju_d')->where('kode_lokasi', $kode_lokasi)->where('no_spj','like' ,$no_agenda.'-%')->delete();
            $del7 = DB::connection('sqlsrvyptkug')->table('tu_pdapp_m')->where('kode_lokasi', $kode_lokasi)->where('no_aju', $no_agenda)->delete();
            $del8 = DB::connection('sqlsrvyptkug')->table('it_aju_dok')->where('kode_lokasi', $kode_lokasi)->where('no_bukti', $no_agenda)->delete();
    ...
    public function kirimNoAgenda(Request $request){
        ...
        try {
            ...
            $cek = DB::connection('sqlsrvyptkug')->select("select a.nilai,a.kode_pp,a.keterangan,a.tanggal,a.kode_pp+' - '+b.nama as pp,a.kode_akun+' - '+c.nama as akun,a.kode_drk+' - '+isnull(d.nama,'-') as drk 
            from it_aju_m a 
            ...
            if(count($cek) > 0){
                ...
                $sql = DB::connection('sqlsrvyptkug')->insert("insert into it_ajuapp_m(no_app,no_aju,kode_lokasi,periode,tgl_input,user_input,tgl_aju,nik_terima) values 
                ...
                $sql2 = DB::connection('sqlsrvyptkug')->table('it_aju_m')
    ...
    public function getAgendaDok($no_agenda){
        try {
            ...
            $res = DB::connection('sqlsrvyptkug')->select("select a.no_aju,a.no_app,convert(varchar,b.tgl_input,103) as tgl_dok
            from it_aju_m a
    ...
    public function getAgendaBayar($no_agenda){
        ...
        try {
            ...
            $res = DB::connection('sqlsrvyptkug')->select("select a.no_aju,a.no_spb,a.no_kas,convert(varchar,a.tanggal,103) as tgl_bayar
            from it_aju_m a
