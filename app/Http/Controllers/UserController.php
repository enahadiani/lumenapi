...
class UserController extends Controller
{
    ...
    public function profile()
    {
        if($data =  Auth::guard('user')->user()){
            ...
            $user = DB::connection('sqlsrv')->select("select a.kode_menu_lab as kode_klp_menu, a.nik, a.nama, a.status_admin, a.klp_akses, a.kode_lokasi,b.nama as nmlok, c.kode_pp,d.nama as nama_pp,
    ...
    public function getMenu($kode_klp)
    {
        try {
            ...
            $menu = DB::connection('sqlsrv')->select("select a.*,b.form from menu a left join m_form b on a.kode_form=b.kode_form where a.kode_klp = '$kode_klp' and (isnull(a.jenis_menu,'-') = '-' OR a.jenis_menu = '') order by kode_klp, rowindex ");
