...
class FilterController extends Controller
{
    ...
    function getFilterTglSurat(Request $request){
        try {
    ...
    function getFilterNoSurat(Request $request){
        try {
            ...
            $sql="select a.no_surat,a.nomor,a.keperluan 
            from rt_surat_antar a 
            $where ";
            $res = DB::connection($this->db)->select($sql);
            $res = json_decode(json_encode($res),true);
