    ...
    public function index(Request $request)
    {
        try {
            ...
            if(isset($request->blok)){
                ...
                $sql= "select a.blok,a.kode_lokasi,a.kode_pp from rt_blok where a.kode_lokasi='".$kode_lokasi."' $filter ";
            }else{
                $sql = "select a.blok,a.kode_lokasi,a.kode_pp from rt_blok where a.kode_lokasi= '".$kode_lokasi."'";
            }
