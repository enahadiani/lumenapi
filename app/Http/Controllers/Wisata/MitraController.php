...
{   
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $res2 = DB::connection($this->sql)->select( "select a.kode_subjenis,a.nama 
            from par_subjenis a 
            inner join par_jenis c on a.kode_jenis=c.kode_jenis and a.kode_lokasi=c.kode_lokasi 
            inner join par_bidang d on c.kode_bidang=d.kode_bidang and c.kode_lokasi=d.kode_lokasi
            inner join par_mitra_subjenis b on a.kode_subjenis=b.kode_subjenis and a.kode_lokasi=b.kode_lokasi and b.kode_mitra='".$request->kode_mitra."' 
