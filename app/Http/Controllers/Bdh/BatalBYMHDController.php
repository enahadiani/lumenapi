...
class BatalBYMHDController extends Controller
{
    /**
    ...
    public function generateNo(Request $request) {
        ...
        try {
            ...
            $no_bukti = $this->generateKode("ju_m", "no_ju", $kode_lokasi."-JU".substr($periode,2,4).".", "0001");
    ...
    public function index(Request $request)
    {
        try {
            ...
            $sql="select a.no_ju,convert(varchar,a.tanggal,103) as tgl,a.no_dokumen,a.keterangan,a.nilai, 
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            if($cek['status']){
                ...
                $del = DB::connection($this->db)->table('ju_m')
                ->where('kode_lokasi', $kode_lokasi)
                ->where('no_ju', $no_bukti)
                ->delete();
    ...
    public function show(Request $request)
    {
        ...
        try {
            ...
            from ju_m a inner join bmhd_bayar b on a.no_ju=b.no_aju and a.kode_lokasi=b.kode_lokasi	
            where a.no_ju = '".$request->no_bukti."' and a.kode_lokasi='".$kode_lokasi."'";
            ...
            if(count($res) > 0){ //mengecek apakah data kosong atau tidak
                ...
                where a.jenis='BEBAN' and a.no_ju = '".$request->no_bukti."' and a.kode_lokasi='".$kode_lokasi."' order by a.no_urut";
    ...
    public function getAkun(Request $request)
    {
        ...
        try {
            ...
            where b.kode_flag in ('034') and a.kode_lokasi= = '".$kode_lokasi."'";
    ...
    public function getPP(Request $request)
    {
        ...
        try {
            ...
            $strPP = "select a.kode_pp,a.nama from pp a inner join karyawan_pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi and b.nik='".$nik."' where a.flag_aktif='1' and a.kode_lokasi= = '".$kode_lokasi."'";
    ...
    public function getDRK(Request $request)
    {
        ...
        try {
            ...
            $vUnion = " union select '-','-' "; 
            $strSQL="select distinct a.kode_drk, a.nama from drk a inner join anggaran_d b on a.kode_drk=b.kode_drk where a.tahun=substring(b.periode,1,4) and b.periode like '".substr($request->periode,0,4)."%' and b.kode_akun='".$request->kode_akun."' and b.kode_pp = '".$request->kode_pp."' and a.kode_lokasi='".$kode_lokasi."' ".$vUnion;
