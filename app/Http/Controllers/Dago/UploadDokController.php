...
class UploadDokController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        try {
            ...
            $sql2="select a.no_dokumen,a.deskripsi,a.jenis,isnull(convert(varchar,b.tgl_terima,111),'-') as tgl_terima,case isnull(c.no_gambar,'-') when '-' then isnull(c.no_gambar,'-') else  '".url('api/dago/storage')."/'+isnull(c.no_gambar,'-') end as fileaddres,isnull(c.nik,'-') as nik 
            from dgw_dok a 
