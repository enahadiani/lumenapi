...
class PaketController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $res2 = DB::connection($this->sql)->select("select kode_harga,no_paket,harga,harga_se,fee,curr_fee from dgw_harga where kode_lokasi='".$kode_lokasi."' and no_paket='$request->no_paket' ");
