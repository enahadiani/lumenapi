...
class AdminYptKugController extends Controller
{
    ...
    public function profile()
    {
        if($data =  Auth::guard('yptkug')->user()){
            ...
            $user = DB::connection('sqlsrvyptkug')->select("select a.kode_menu_lab as kode_klp_menu, a.nik, a.nama, a.status_admin, a.klp_akses, a.kode_lokasi,b.nama as nmlok, c.kode_pp,d.nama as nama_pp,
			b.kode_lokkonsol,d.kode_bidang, c.foto,isnull(e.form,'-') as path_view,b.logo,c.no_telp,c.jabatan,a.flag_menu,isnull(c.email,'-') as email,a.pass as password,isnull(c.background,'-') as background,isnull(f.nama,'-') as nama_bidang
            from hakakses a 
            ...
            left join bidang f on d.kode_bidang=f.kode_bidang and d.kode_lokasi=f.kode_lokasi
