...
class StatusGuruController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $res = DB::connection('sqlsrvtarbak')->select( "select a.kode_status, a.nama, a.flag_aktif,a.kode_pp+'-'+b.nama as pp,a.tgl_input,case when datediff(minute,a.tgl_input,getdate()) <= 10 then 'baru' else 'lama' end as status  
