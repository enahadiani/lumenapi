...
class FilterController extends Controller
{
    ...
    function getFilterPP(Request $request){
        try {
            ...
            $sql="select a.kode_pp,a.nama from pp a $where";
            $res = DB::connection($this->db)->select($sql);
            $res = json_decode(json_encode($res),true);
    ...
    function getFilterTA(Request $request){
        try {
    ...
    function getFilterKelas(Request $request){
        try {
    ...
    function getFilterMatpel(Request $request){
        try {
    ...
    function getFilterSemester(){
        try {
            ...
            $res = array(
                0 => array('kode_sem' => "1", 'nama' => 'Ganjil'),
                1 => array('kode_sem' => "2", 'nama' => 'Genap')
            );
