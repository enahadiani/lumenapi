...
class GuruMatpelController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $res = DB::connection('sqlsrvtarbak')->select("select distinct a.nik,a.nama,a.kode_pp+'-'+c.nama as pp,b.tgl_input,case when datediff(minute,b.tgl_input,getdate()) <= 10 then 'baru' else 'lama' end as status from sis_guru_matpel b inner join karyawan a on a.nik=b.nik and a.kode_lokasi=b.kode_lokasi and a.kode_pp=b.kode_pp inner join pp c on a.kode_lokasi=c.kode_lokasi and a.kode_pp=c.kode_pp  
    ...
    public function show(Request $request)
    {
        ...
        try {
            ...
            $res = DB::connection('sqlsrvtarbak')->select("select a.kode_pp, a.nik as nik_guru,a.flag_aktif,b.nama as nama_pp,c.nama as nama_guru, case a.flag_aktif when 1 then 'AKTIF' else 'NONAKTIF' end as nama_status 
            ...
            where a.nik='$nik_guru' and a.kode_lokasi='".$kode_lokasi."' and a.kode_pp='".$kode_pp."' group by a.kode_pp,a.nik,a.flag_aktif,b.nama,c.nama");
            $res = json_decode(json_encode($res),true);
