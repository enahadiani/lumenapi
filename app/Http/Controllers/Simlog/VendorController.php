...
class VendorController extends Controller
{
    ...
    public function isUnik($isi,$kode_lokasi){
        ...
        $auth = DB::connection($this->db)->select("select kode_vendor from vendor where kode_vendor ='".$isi."' and kode_lokasi='".$kode_lokasi."' ");
