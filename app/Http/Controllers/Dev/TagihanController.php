...
class TagihanController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        try {
            ...
            $res = DB::connection($this->db)->select("select no_tagihan,substring(convert(varchar,tanggal,120),1,10) as tanggal,periode,keterangan,periode,nim from dev_tagihan_m where no_tagihan = '".$no_tagihan."' and kode_lokasi='".$kode_lokasi."'");						
            $res= json_decode(json_encode($res),true);
