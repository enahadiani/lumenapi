...
class SDMKaryawanExport implements FromCollection, WithHeadings, WithColumnFormatting, WithEvents
{
    ...
    public function collection()
    {
        if($this->type == 'template'){
            ...
            '' as status_nikah, '' as tgl_nikah, '' as kode_gol, '' as kode_sdm, '' as kode_unit, '' as kode_pp, '' as kode_loker, 
            ...
            kode_gol, kode_sdm, kode_unit, kode_pp, kode_loker, convert(varchar(10), tgl_masuk, 101) as tgl_masuk, npwp, no_bpjs, no_bpjs_kerja, kode_profesi, bank, cabang, 
