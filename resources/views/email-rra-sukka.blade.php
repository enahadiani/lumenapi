        ...
        .bold {
            ...
            <div class="row px-4">
                <div class="col-12" style="border-bottom:3px solid black;text-align:center">
                    <h4 style="margin-bottom:0px !important">PENGAJUAN</h4>
                    <h4>RRA</h4>
                </div>
                <div class="col-12 my-2" style="text-align:center">
                    <h4>Nomor : {{ $data[0]['no_pdrk'] }}</h4>
                </div>
                <div class="col-12">
                    <table class="table table-condensed table-bordered" width="100%"  id="table-m">
                        <tbody>
                            <tr>
                                ...
                                <td width="70%" id="print-unit">{{ $data[0]['periode'] }}</td>
                            </tr>
                            <tr>
                                <td width="5%">2</td>
                                <td width="25">TANGGAL</td>
                                <td width="70%" id="print-unit">{{ $data[0]['tanggal'] }}</td>
                            </tr>
                            <tr>
                                <td width="5%">3</td>
                                <td width="25">KETERANGAN</td>
                                <td width="70%" id="print-unit">{{ $data[0]['keterangan'] }}</td>
                            </tr>
                            <tr>
                                <td>4</td>
                                <td>DIBUAT OLEH</td>
                                <td id="print-pic">{{ $data[0]['nik_buat'] }} {{ $data[0]['nama_buat'] }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
